(function (factory) {
    ...
    if (typeof require === "function" && typeof exports === "object" && typeof module === "object") {
        // CommonJS or Node: hard-coded dependency on "ko"
       
        factory(require("ko"), require("chart"), exports);
    } else if (typeof define === "function" && define["amd"]) {
        // AMD anonymous module with hard-coded dependency on "ko"
        define(["ko", "chart", "exports"], factory);
    } else {
    ...
    (function (ko, Chart, exports) {
        ...
        ko.bindingHandlers.chart = {
            init: function (element, valueAccessor, allBindingsAccessor, viewModel) {
                ...
                if (chartBinding.options) { subscribeToChanges(); }
            }
        };
